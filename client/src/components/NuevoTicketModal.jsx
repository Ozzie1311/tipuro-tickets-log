...
const NuevoTicketModal = ({onClose, onTicketCreado}) => {
   ...
   return (
    <div className='fixed inset-0 bg-black/70 backdrop-blur-sm flex items-end justify-center z-50 animate-fadeIn' onClick={onClose}>
        <div className='bg-zinc-900 w-full rounded-t-3xl p-6 flex flex-col gap-4 pb-10 animate-slideUp' onClick={(e) => e.stopPropagation()}>
            ...
            <div className='flex items-center justify-between'>
                    ...
                    <button onClick={onClose} className='text-red-400 text-sm font-medium'>Cancelar</button>
                </div>
                ...
                <form onSubmit={handleSubmit} className='flex flex-col gap-3'>
                    ...
                    <textarea
                        ...
                        rows={4}
                    />
                    <button type='submit' className='bg-blue-500 text-white rounded-xl p-3 font-semibold mt-1 active:scale-95 transition-transform duration-150'>
                        Crear ticket
                    </button>
                </form>
            </div>
